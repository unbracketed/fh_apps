...
from fasthtml.common import A, Div, H1, Title, uri, Nav, Img, Button, Span, Svg, Header, Main, H2
...
def COMMENT(*args): return ""


def SL_Nav_Profile_Menu():
    return COMMENT(Div(cls='hidden sm:ml-6 sm:flex sm:items-center')(
                        Button(type='button',
                            ...
                            Svg(fill='none', viewbox='0 0 24 24', stroke_width='1.5',
                                stroke='currentColor', aria_hidden='true', cls='h-6 w-6')(
                                svg.Path(stroke_linecap='round', stroke_linejoin='round',
                        ...
                        Div(cls='relative ml-3')(
                            Div(
                                Button(type='button', id='user-menu-button',
                                       aria_expanded='false', aria_haspopup='true',
                                    ...
                                    Img(src='https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
                                        alt='', cls='h-8 w-8 rounded-full')
                                )
                            ),
                            Div(role='menu', aria_orientation='vertical',
                                aria_labelledby='user-menu-button', tabindex='-1',
                                ...
                                A('Your Profile', href='#', role='menuitem', tabindex='-1',
                                  id='user-menu-item-0',
                                  cls='block px-4 py-2 text-sm text-gray-700'),
                                A('Settings', href='#', role='menuitem', tabindex='-1',
                                  id='user-menu-item-1',
                                  cls='block px-4 py-2 text-sm text-gray-700'),
                                A('Sign out', href='#', role='menuitem', tabindex='-1',
                                  id='user-menu-item-2',
                                  cls='block px-4 py-2 text-sm text-gray-700')
                            )
                        )
...
def SL_Nav_Profile_Menu_Mobile():
    return COMMENT(Div(cls='border-t border-gray-200 pb-3 pt-4')(
                    Div(cls='flex items-center px-4')(
                        Div(cls='flex-shrink-0')(
                            Img(src='https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
                                alt='', cls='h-10 w-10 rounded-full')
                        ),
                        Div(cls='ml-3')(
                    ...
                    Div(cls='flex')(
                        Div(cls='flex flex-shrink-0 items-center')(
                            Img(src='https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600',
                                alt='Your Company', cls='block h-8 w-auto lg:hidden'),
                            Img(src='https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600',
                                alt='Your Company', cls='hidden h-8 w-auto lg:block')
                        ),
                        Div(cls='hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8')(
                            A('Dashboard', href='#', aria_current='page',
                            ...
                            A('Venues', href='/venues/',
                              cls='inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700'),
                            A('Calendar', href='/calendar/',
                              cls='inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700')
                        )
                    ),
                    SL_Nav_Profile_Menu(),
                    Div(cls='-mr-2 flex items-center sm:hidden')(
                        Button(type='button', aria_controls='mobile-menu',
                               aria_expanded='false',
                            ...
                            Svg(fill='none', viewbox='0 0 24 24', stroke_width='1.5',
                                stroke='currentColor', aria_hidden='true', cls='block h-6 w-6')(
                                svg.Path(stroke_linecap='round', stroke_linejoin='round',
                                         d='M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5')
                            ),
                            Svg(fill='none', viewbox='0 0 24 24', stroke_width='1.5',
                                stroke='currentColor', aria_hidden='true',
                                cls='hidden h-6 w-6')(
                                svg.Path(stroke_linecap='round', stroke_linejoin='round',
...
def StackedLayout(title: str, view_actions, *children, **attrs):
